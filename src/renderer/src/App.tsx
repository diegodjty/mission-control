...
export function App(): JSX.Element {
  ...
  // applies at fire time, but a gate that would PROMPT interactively instead
  // SKIPS with a notification, since nobody is there to answer a dialog at a
  // scheduled time. A HITL park reached mid-drain (issue 64) is unaffected —
  // that only runs once the drain has already started. One-shot and
